...
Flow:
  ...
  4. Create lead in ReSimpli â skip trace â enroll drip
"""
...
# ââ Env vars (same names as before, NJ_USERNAME/NJ_PASSWORD no longer needed) ââ
...
# ââ County PRESS portal configs ââââââââââââââââââââââââââââââââââââââââââââââ
...
# ââ NJ MOD-IV / tax assessor API (free, no key needed) âââââââââââââââââââââââ
...
def scrape_essex(page, from_date_str, to_date_str):
    ...
    for doc_val, doc_label in doc_types:
        ...
        page_num = 1
        while True:
            # Precise selectors — only real lis pendens data rows
...
def enrich_address(record):
    ...
    1. Block/Lot â MOD-IV lookup
    2. Name + city â MOD-IV lookup (fallback)
...
def scrape_all():
    ...
    print(f'Date range: {from_str} â {to_str}')
...
def main():
    print(f'\nNJ Foreclosure Bot v2 â {datetime.now()}')
